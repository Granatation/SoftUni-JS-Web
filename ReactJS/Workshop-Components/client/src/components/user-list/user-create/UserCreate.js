                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    ...
                                    <input id="email" name="email" type="text" value={values.email} onChange={changeHandler} onBlur={(e) => minLength(e, 10)} />
                                </div>
                                {errors.email &&
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    ...
                                    <input id="streetNumber" name="streetNumber" type="text" value={values.streetNumber} onChange={changeHandler} onBlur={(e) => isNegative(e)} />
                                </div>
                                {errors.streetNumber &&
                                    <p className="form-error">
